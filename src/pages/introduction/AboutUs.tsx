      ...
      <section ref={sectionRef} className="w-full flex flex-col items-center min-h-[80vh] pt-20 pb-20 bg-white">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-14 items-stretch">
            {/* Gallery Card */}
            <Card className={`bg-white border border-gray-100 shadow-lg rounded-2xl flex flex-col justify-between p-0 transition-all duration-1000 ${isVisible ? 'animate-fly-in-left animation-delay-400' : 'translate-x-[-100%] translate-y-[20px] opacity-0'}`}>
            ...
            {/* History and Values */}
            <Card className={`bg-gray-50 border border-gray-100 shadow-lg p-8 rounded-2xl flex flex-col justify-center min-h-[310px] transition-all duration-1000 ${isVisible ? 'animate-fly-in-left animation-delay-400' : 'translate-x-[-100%] translate-y-[20px] opacity-0'}`}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {stats.map((stat, index) => (
              <Card 
                key={stat.label} 
                className={`bg-white flex flex-col items-center py-7 px-2 border border-gray-200 rounded-xl shadow hover:shadow-md transition-all duration-1000 ${isVisible ? `animate-fly-in-left animation-delay-${(index + 1) * 200}` : 'translate-x-[-100%] translate-y-[20px] opacity-0'}`}
              >
          ...
          {/* Our Values Section */}
          <div className={`bg-[#FAFAFA] rounded-2xl py-10 px-7 md:px-16 shadow-sm border border-gray-100 mb-10 transition-all duration-1000 ${isVisible ? 'animate-fly-in-left animation-delay-600' : 'translate-x-[-100%] translate-y-[20px] opacity-0'}`}>
          ...
          <div className="flex justify-center">
            <Button 
              className={`bg-brand-red hover:bg-black text-white px-10 py-3 text-lg rounded-lg font-bold shadow transition-all duration-1000 ${isVisible ? 'animate-fly-in-left animation-delay-600' : 'translate-x-[-100%] translate-y-[20px] opacity-0'}`} 
