...
const Hero = () => {
  ...
  return (
    <section
      className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden hero-bg"
    >
      {/* Vivid cover visual */}
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-white/85 mix-blend-lighten"></div>
      </div>
      {/* Hero Content */}
      <div className="section-container relative z-10 w-full flex flex-col items-center">
        <h1 className="font-extrabold mb-2 text-5xl md:text-6xl text-center tracking-tighter text-brand-red drop-shadow-sm">
          COMPANY PROFILE
        </h1>
        <h2 className="text-lg md:text-xl mb-6 text-center font-semibold tracking-wide uppercase text-black">
          Vị mặn tinh khiết cho sức khỏe Việt
        </h2>
        <p className="text-xl md:text-2xl mb-8 text-black max-w-2xl text-center font-medium">
