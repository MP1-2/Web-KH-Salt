      ...
      <div className="section-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-body mb-6 animate-fade-in-up animation-delay-200">
              {t('home.about.desc')}
            </p>
            <p className="text-body mb-8 animate-fade-in-up animation-delay-200">
            ...
            <Button className="bg-brand-red hover:bg-red-700 text-white animate-fade-in-up animation-delay-400">
